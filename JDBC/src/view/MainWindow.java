...
public class MainWindow extends Application {
    ...
    GestionEnListaEnMemoria g = new GestionEnListaEnMemoria();
    ...
    public void start(Stage stage) throws ParserConfigurationException, SAXException, IOException {
        ...
        final Button aldatuButton = new Button("Aldatu");        
        aldatuButton.setOnAction((ActionEvent e) -> {
        ...
        hb.getChildren().addAll(addName, addJatorri, adddesk, addurtea, addButton, removeButton, aldatuButton);
        hb.setSpacing(3);
        ...
        table.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
            if (newSelection != null) {
                Armak aukeratutakoPelikula = table.getSelectionModel().getSelectedItem();
                addName.setText(aukeratutakoPelikula.getName());
                addJatorri.setText(aukeratutakoPelikula.getJatorria());
                adddesk.setText(aukeratutakoPelikula.getDesk());
                addurtea.setText(String.valueOf(aukeratutakoPelikula.getUrtea()));
                //gehituH
